        ...
        <div class="row justify-content-center">
            ...
            <?php
                if(isset($_POST['editar'])){
                    ...
                    $query = "UPDATE peliculas SET peli_nombre = '{$peli_nombre}', peli_genero = '{$peli_genero}', peli_estreno = '{$peli_estreno}', peli_restricciones = '{$peli_restricciones}', peli_img = '{$peli_img}', peli_dire_id = {$peli_dire_id} WHERE peli_id = {$id}";
