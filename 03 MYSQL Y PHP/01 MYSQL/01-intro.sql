-- mysql -u root
-- mysql -u <usuario> -p   (para ingresar con contraseña)
...
INSERT INTO peliculas (peli_dire_id, peli_nombre, peli_genero, peli_estreno, peli_restricciones) VALUES
    ('1', 'Spiderman: No way home', 'Acción', '2021-12-15', 'PG-13'),
    ('2','Matrix', 'ciencia ficcion', '1999-10-10', 'PG-13'),
    ('','El codigo enigma', 'Belica', '2017-05-05', 'PG-16'),
    ('3','Titanic', 'Drama Romantico', '1997-09-09', 'PG'),
    ('4','Interestellar', 'Ciencia Ficción', '2014-02-02', 'PG'),
    ('5','El Resplandor', 'Terror', '1980-04-04', 'PG-18'),
    ('','50 sombras de gray', 'Thriller', '2013-06-06', 'PG-18'),
    ('6','Django', 'Wenstern', '2016-12-12', 'PG-16'),
    ('6','Pulp Fiction', 'Policial', '2010-10-10', 'PG-16')
